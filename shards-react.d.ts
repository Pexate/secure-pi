...
declare module "shards-react" {
  ...
  interface BaseProps extends React.AllHTMLAttributes<any> {
    /**
     * The class name.
     */
    className?: string;
  ...
  export declare const ListGroupItemHeading: React.ComponentType<ListGroupItemHeadingProps>;

  export interface ListGroupItemTextProps extends BaseProps {}

  export declare const ListGroupItemText: React.ComponentType<ListGroupItemTextProps>;
